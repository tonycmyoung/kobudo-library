...
describe("MetadataManagement", () => {
  ...
  it("should render the component with title and description", () => {
    ...
    expect(screen.getByText("Manage curriculum, categories, and performers")).toBeInTheDocument()
  })
  ...
  it("should render tabs for all three sections", () => {
    ...
    expect(screen.getByRole("tab", { name: /performers/i })).toBeInTheDocument()
  })
  ...
  it("should display curriculum tab as active by default", () => {
    ...
    expect(screen.getByText("Curriculum Sets Management Component")).toBeInTheDocument()
  })
  ...
  it("should switch to performers tab when clicked", async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText("Performer Management Component")).toBeInTheDocument()
    })
  })
